    ...
    <footer className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 text-white overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 lg:py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 lg:gap-12">
          ...
          {/* Quick Links Column - FIXED LINKS */}
          <div className="text-center sm:text-left space-y-4">
            <h3 className="text-lg sm:text-xl font-bold text-white mb-4 pb-2 border-b-2 border-green-500 inline-block">
              Quick Links
            </h3>
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-gray-300 hover:text-white transition-all flex items-center justify-center sm:justify-start group">
                  <span className="w-0 group-hover:w-4 h-0.5 bg-green-500 mr-0 group-hover:mr-2 transition-all"></span>
                  Home
                </Link>
              </li>
              <li>
                <Link to="/categories" className="text-gray-300 hover:text-white transition-all flex items-center justify-center sm:justify-start group">
                  <span className="w-0 group-hover:w-4 h-0.5 bg-green-500 mr-0 group-hover:mr-2 transition-all"></span>
                  Categories
                </Link>
              </li>
              <li>
                <Link to="/plants" className="text-gray-300 hover:text-white transition-all flex items-center justify-center sm:justify-start group">
                  <span className="w-0 group-hover:w-4 h-0.5 bg-green-500 mr-0 group-hover:mr-2 transition-all"></span>
                  All Plants
                </Link>
              </li>
              <li>
                <Link to="/gallery" className="text-gray-300 hover:text-white transition-all flex items-center justify-center sm:justify-start group">
                  <span className="w-0 group-hover:w-4 h-0.5 bg-green-500 mr-0 group-hover:mr-2 transition-all"></span>
                  Gallery
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-300 hover:text-white transition-all flex items-center justify-center sm:justify-start group">
                  <span className="w-0 group-hover:w-4 h-0.5 bg-green-500 mr-0 group-hover:mr-2 transition-all"></span>
                  Contact
                </Link>
              </li>
          ...
          <div className="text-center sm:text-left space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/categories/fruits" className="text-gray-300 hover:text-white transition-all flex items-center justify-center sm:justify-start group">
                  <span className="w-0 group-hover:w-4 h-0.5 bg-green-500 mr-0 group-hover:mr-2 transition-all"></span>
                  🍎 Fruits
                </Link>
              </li>
              <li>
                <Link to="/categories/flowers" className="text-gray-300 hover:text-white transition-all flex items-center justify-center sm:justify-start group">
                  <span className="w-0 group-hover:w-4 h-0.5 bg-green-500 mr-0 group-hover:mr-2 transition-all"></span>
                  🌸 Flowers
                </Link>
              </li>
              <li>
                <Link to="/categories/indoor-plants" className="text-gray-300 hover:text-white transition-all flex items-center justify-center sm:justify-start group">
                  <span className="w-0 group-hover:w-4 h-0.5 bg-green-500 mr-0 group-hover:mr-2 transition-all"></span>
                  🏠 Indoor Plants
                </Link>
              </li>
              <li>
                <Link to="/categories/outdoor-plants" className="text-gray-300 hover:text-white transition-all flex items-center justify-center sm:justify-start group">
                  <span className="w-0 group-hover:w-4 h-0.5 bg-green-500 mr-0 group-hover:mr-2 transition-all"></span>
                  🌳 Outdoor Plants
                </Link>
              </li>
